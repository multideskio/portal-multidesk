   ...
   <div id="scrollbar">
      <div class="container-fluid">
         ...
         <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
               <a class="nav-link menu-link" href="#sidebarCursos" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCursos">
                  <i class="ri-book-open-line"></i> <span>Cursos</span>
               </a>
               <div class="collapse menu-dropdown" id="sidebarCursos">
             ...
             <li class="nav-item">
                 <a class="nav-link menu-link" href="#sidebarEventos" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarEventos">
             ...
             <li class="nav-item">
                 <a class="nav-link menu-link" href="#sidebarAnalises" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAnalises">
             ...
             <li class="nav-item">
                 <a class="nav-link menu-link" href="#sidebarIntegracoes" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarIntegracoes">
             ...
             <li class="nav-item">
                 <a class="nav-link menu-link" href="#sidebarConfiguracoes" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarConfiguracoes">
