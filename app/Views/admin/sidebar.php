<div class="geex-sidebar">
    ...
    <div class="geex-sidebar__wrapper">
        <div class="geex-sidebar__header">
            <a href="/admin" class="geex-sidebar__logo">
            ...
            <ul class="geex-sidebar__menu">
                    ...
                    <a href="#" class="geex-sidebar__menu__link">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_1139_9709)">
                                <path d="M1.83333 10.0833H11.9167C12.4029 10.0833 12.8692 9.89018 13.213 9.54636C13.5568 9.20255 13.75 8.73623 13.75 8.25V1.83333C13.75 1.3471 13.5568 0.880788 13.213 0.536971C12.8692 0.193154 12.4029 0 11.9167 0L1.83333 0C1.3471 0 0.880788 0.193154 0.536971 0.536971C0.193154 0.880788 0 1.3471 0 1.83333L0 8.25C0 8.73623 0.193154 9.20255 0.536971 9.54636C0.880788 9.89018 1.3471 10.0833 1.83333 10.0833ZM1.83333 1.83333H11.9167V8.25H1.83333V1.83333Z"
                                      fill="#B9BBBD"/>
                ...
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu" style="margin-top: 5px;">
                        ...
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Criar novo</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Lista de eventos</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Participantes</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Ler QrCode</a>
                        </li>
                    </ul>
                </li>
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu" style="margin-top: 5px;">
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Pedidos</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Clientes</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Código de desconto</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Configurações</a>
                        </li>
                    </ul>
                </li>
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu" style="margin-top: 5px;">
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Visão geral</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Produtos</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Receita</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Pedidos</a>
                        </li>
                ...
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu" style="margin-top: 5px;">
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Gateways</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">WhatsApp</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">WebHook</a>
                        </li>
                    </ul>
                </li>
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu" style="margin-top: 5px;">
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Empresa</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="" class="geex-sidebar__menu__link">Usuários</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="geex-sidebar__footer">
            <span class="geex-sidebar__footer__title">Multidesk.io</span>
