						...
						<ul class="geex-content__header__quickaction">
							<li class="geex-content__header__quickaction__item">
								<a href="#" class="geex-content__header__quickaction__link">
									<img class="notification-img" src="<?= $this->Url->assetUrl('assets/img/avatar/chat.svg') ?>" alt="chat" />
									<span class="geex-content__header__badge">84</span>
								</a>
							</li>
							<li class="geex-content__header__quickaction__item">
								<a href="#" class="geex-content__header__quickaction__link">
									<img class="notification-img" src="<?= $this->Url->assetUrl('assets/img/avatar/notification.svg') ?>" alt="chat" />
									<span class="geex-content__header__badge bg-info">2</span>
								</a>
							</li>
							<li class="geex-content__header__quickaction__item">
								<a href="#" class="geex-content__header__quickaction__link">
									<img class="user-img" src="<?= $this->Url->assetUrl('assets/img/avatar/user.svg') ?>" alt="user" />
								</a>
							</li>
						</ul>
					</div>
