                        ...
                        <div class="transaction-content">
                            ...
                            <div class="transaction-type">
                                <div class="transaction-type__single">
                                    <div class="transaction-type__single__icon">
                                        <img src="<?= $this->Url->assetUrl('assets/img/avatar/t1.svg') ?>" alt="user" />
                                    </div>
                                    <div class="transaction-type__single__content">
                                ...
                                <div class="transaction-type__single">
                                    <div class="transaction-type__single__icon">
                                        <img src="<?= $this->Url->assetUrl('assets/img/icon/dropbox.svg') ?>" alt="user" />
                                    </div>
                                    <div class="transaction-type__single__content">
                                ...
                                <div class="transaction-type__single">
                                    <div class="transaction-type__single__icon">
                                        <img src="<?= $this->Url->assetUrl('assets/img/avatar/t2.svg') ?>" alt="user" />
                                    </div>
                                    <div class="transaction-type__single__content">
                                ...
                                <div class="transaction-type__single">
                                    <div class="transaction-type__single__icon">
                                        <img src="<?= $this->Url->assetUrl('assets/img/icon/youtube.svg') ?>" alt="user" />
                                    </div>
                                    <div class="transaction-type__single__content">
                                ...
                                <div class="transaction-type__single">
                                    <div class="transaction-type__single__icon">
                                        <img src="<?= $this->Url->assetUrl('assets/img/avatar/t3.svg') ?>" alt="user" />
                                    </div>
                                    <div class="transaction-type__single__content">
            ...
            <div class="geex-content__widget__single__mastercard">
                ...
                <div class="geex-content__widget__single__mastercard__bottom single-content">
                    ...
                    <div class="geex-content__widget__single__mastercard__bottom__icon">
                        <img src="<?= $this->Url->assetUrl('assets/img/icon/mastercard-icon.svg') ?>" alt="mastercard" />
