                                    ...
                                    <div id="one" class="stage" data-stage-id="1">
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/01.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/02.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/03.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/04.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
                                        ...
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/08.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/09.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
                                    ...
                                    <div id="two" class="stage" data-stage-id="2">
                                        ...
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/05.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/06.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
                                    ...
                                    <div id="three" class="stage" data-stage-id="3">
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/14.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/15.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
                                    ...
                                    <div id="four" class="stage" data-stage-id="4">
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/12.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/13.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
                                    ...
                                    <div id="five" class="stage" data-stage-id="5">
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/16.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/17.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
                                        ...
                                        <div class="deal" class="dragme">
                                            <div class="inner-content-kanban-wrapper">
                                                ...
                                                <div class="thumb-edit-area">
                                                    <div class="img-area">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/18.png') ?>" alt="kanban">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/19.png') ?>" alt="kanban">
                                                    </div>
                                                    <div class="edit-img">
                                                        <img src="<?= $this->Url->assetUrl('assets/img/kanban/20.png') ?>" alt="kanban">
                                                    </div>
