		...
		<div class="row gutter-40">
			...
			<div class="col-lg-4 col-sm-6 mb-40">
				<div class="geex-content__testimonial__single">
					<img src="<?= $this->Url->assetUrl('assets/img/icon/quotes.svg') ?>" alt="image" class="geex-content__testimonial__single__quote">
					...
					<div class="geex-content__testimonial__single__author">
						...
						<img src="<?= $this->Url->assetUrl('assets/img/testimonial/1.svg') ?>" alt="image" class="geex-content__testimonial__single__author__img">
					</div>
				</div>
			</div>
			<!-- TESTIMONIAL ITEM -->
			<div class="col-lg-4 col-sm-6 mb-40">
				<div class="geex-content__testimonial__single">
					...
					<div class="geex-content__testimonial__single__author">
						...
						<span class="geex-content__testimonial__single__author__subtitle">Merchandising Market Manager</span>
						<img src="<?= $this->Url->assetUrl('assets/img/testimonial/2.svg') ?>" alt="image" class="geex-content__testimonial__single__author__img">
					</div>
				</div>
			</div>
			<!-- TESTIMONIAL ITEM -->
			<div class="col-lg-4 col-sm-6 mb-40">
				<div class="geex-content__testimonial__single">
					...
					<div class="geex-content__testimonial__single__author">
						...
						<span class="geex-content__testimonial__single__author__subtitle">Merchandising Market Manager</span>
						<img src="<?= $this->Url->assetUrl('assets/img/testimonial/3.svg') ?>" alt="image" class="geex-content__testimonial__single__author__img">
					</div>
				</div>
			</div>
			<!-- TESTIMONIAL ITEM -->
			<div class="col-lg-4 col-sm-6 mb-40">
				<div class="geex-content__testimonial__single">
					...
					<div class="geex-content__testimonial__single__author">
						...
						<span class="geex-content__testimonial__single__author__subtitle">Merchandising Market Manager</span>
						<img src="<?= $this->Url->assetUrl('assets/img/testimonial/4.svg') ?>" alt="image" class="geex-content__testimonial__single__author__img">
					</div>
				</div>
			</div>
			<!-- TESTIMONIAL ITEM -->
