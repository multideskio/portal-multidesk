...
<head>
	...
	<!-- inject:css-->
	<link rel="stylesheet" href="<?= $this->Url->assetUrl('assets/vendor/css/bootstrap/bootstrap.css') ?>">
	<link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css">
	<link rel="stylesheet" href="<?= $this->Url->assetUrl('assets/css/style.css') ?>">
	<!-- endinject -->
	<link rel="icon" type="image/png" sizes="16x16" href="<?= $this->Url->assetUrl('assets/img/favicon.svg') ?>">
	<!-- Fonts -->
	...
	<main class="geex-content">
		<div class="geex-content__authentication">
				...
				<div class="geex-content__authentication__content__wrapper">
					<div class="geex-content__authentication__content__logo">
						<a href="<?= $this->Url->build(['_name' => 'index']) ?>">
							<img class="logo-lite" src="<?= $this->Url->assetUrl('assets/img/logo-dark.svg') ?>" alt="logo">
							<img class="logo-dark" src="<?= $this->Url->assetUrl('assets/img/logo-lite.svg') ?>" alt="logo">
						</a>
					</div>
					<!-- SIGNUP FORM START -->
					<form id="signInForm" class="geex-content__authentication__form">
						...
						<div class="geex-content__authentication__form-footer">
							already have an account? <a href=""<?= $this->Url->build(['_name' => 'signin']) ?>"">Sign In</a>
						</div>
					</form>
					<!-- SIGNUP FORM END -->
				</div>
			...
			<div class="geex-content__authentication__img">
				<img src="<?= $this->Url->assetUrl('assets/img/authentication.svg') ?>" alt="">
			</div>
