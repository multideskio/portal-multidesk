...
<div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 20px;">

    <!-- Logo -->
    <div style="text-align: center; margin-bottom: 20px; margin-top: 40px;">
        <img src="https://portal.multidesk.io/assets/img/logo-dark.png" alt="Logo da Empresa" style="max-width: 150px;">
    </div>
    ...
    <p style="font-size: 16px; color: #444444; margin: 10px 0; font-weight: 600;">
        ...
        Sua conta foi criada com sucesso durante o processo de compra. Agora você pode começar a usar nossa plataforma.
    </p>

    <!-- Mensagem secundária -->
    <p style="font-size: 14px; color: #666666; margin: 20px 0;">
        Caso você não tenha realizado a compra ou criado uma conta conosco, por favor entre em contato com nosso suporte
        imediatamente.
    </p>
    ...
    <!-- Rodapé -->
    <p style="font-size: 12px; color: #999999; margin-top: 20px; border-top: 1px solid #eeeeee; padding-top: 10px; margin-bottom: 40px">
